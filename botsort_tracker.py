...
# ── Ayarlar ───────────────────────────────────────────────────────────────
MODEL_PATH = Path(r"C:\Users\ZEKİ\Desktop\BotsortTakipAlgoritmasi\runs\detect\best_26n2.pt")
...
YOLO_CONF = 0.25             # 0.15 idi  YOLO güven eşiği (daha çok tespit, daha iyi kilitlenme)
DETECT_INTERVAL = 5        # TRACK modunda kaç karede bir YOLO çalıştır (Daha sık kontrol = Kopmaz kilit)
